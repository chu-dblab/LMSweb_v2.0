...
{
    /// <inheritdoc />
    public partial class add_HasData_2 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { "TR01B", null, "5", "我們覺得這次小組任務可以獲得幾分?", "0" },
                    { "TR02B", null, "5", "在本次學習任務中，我們小組採用了以下哪些學習方法? (可複選)", "1" },
                    { "TR03B", null, "5", "在本次學習任務中，我們小組積極參與了以下哪些合作任務? (可複選)", "1" },
                    { "TR04B", null, "5", "依據上述反思，我們小組覺得下個任務可以如何改進?", "2" }
                });
